...
A rug is when a team pulls the money out of a pool and leaves. On Dollhouse, every pool keeps its money for good, for everyone including the team, and every coin's whole supply goes into its pool at launch.

The fee, the shares, the price curve, the timings, the bond and every round's result are fixed by the contracts. Trading runs on the contracts alone: every wallet can trade, every balance moves freely, and every coin's supply is fixed at launch.
