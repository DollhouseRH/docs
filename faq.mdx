...
On Dollhouse, every pool keeps its money for good, and every coin's whole supply goes into its pool at launch.

The fee, the shares, the price curve, the timings, the bond and every round's result are fixed by the contracts. 
