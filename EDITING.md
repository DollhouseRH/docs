...
Every `*.mdx` file in this folder is one published page: `launching-a-coin.mdx`, `how-a-round-works.mdx`, `faq.mdx`, and so on. `README.md` and this file are not pages; they are notes for whoever works on the folder.
